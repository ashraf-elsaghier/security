...
const csp = [
  "default-src 'self'",
  // Limit where forms can post to
  "form-action 'self'",
  // Disallow document.base from pointing elsewhere
  "base-uri 'self'",
  // Next.js and our app inject inline styles (styled-jsx), so 'unsafe-inline' for style is needed unless we migrate to nonces
  "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://css.zohocdn.com https://*.zohocdn.com",
  // Some scanners check style-src-elem specifically
  "style-src-elem 'self' 'unsafe-inline' https://fonts.googleapis.com https://css.zohocdn.com https://*.zohocdn.com",
  ...
  // Some scanners check script-src-elem specifically
  "script-src-elem 'self' https://www.googletagmanager.com https://www.google-analytics.com https://www.clarity.ms https://salesiq.zoho.com https://maps.googleapis.com https://js.zohocdn.com https://*.zohocdn.com",
  ...
  "object-src 'none'",
  // If everything is HTTPS, upgrade mixed content automatically
