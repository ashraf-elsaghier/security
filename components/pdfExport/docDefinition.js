export default function getDocDefinition(
  ...
  function getColumnsToExport() {
    ...
    // remove action col header from pdf 
    const columnsToExportWithoutActionCol = columnsToExport.filter(col => {
      return col.text !== "Actions"
    })
    return columnsToExportWithoutActionCol;
  }
  ...
  function createTableCell(cellValue, colId) {
    ...
    const tableCell = {
      text: cellValue !== null ? cellValue : "N/A",
      style: "tableCell",
    };
