...
const InputsFilter = ({
  ...
  useEffect(() => {
    if (filterStatus !== "InputFilter") {
      ...
      if (serialNumberRef.current) serialNumberRef.current.value = "";
      if (plateNumberRef.current) plateNumberRef.current.value = "";
      if (addressRef.current) addressRef.current.value = "";
      if (speedToRef.current) speedToRef.current.value = "";
      if (speedFromRef.current) speedFromRef.current.value = "";
